...
// class Tail_Mask ( ) extends Module {
//     val io = IO (new Bundle {
//         val V_out_alu = Input ( UInt (128.W) ) 
//         val v0 = Input (UInt (128.W) )              
//         val alu_vd_data_pre = Input (UInt (128.W) )
//         val tm_sew = Input (UInt (3.W))
//         val tm_vl = Input ( UInt(32.W) )
//         val tm_vm = Input ( UInt (1.W) ) 
//         val tm_vta = Input ( UInt (1.W) )
...
//         val Vector_Out = Output ( UInt (128.W) )
// })

// val tm_out8 = VecInit(Seq.fill(16)(0.U(8.W)))
// val tm_out16 = VecInit(Seq.fill(8)(0.U(16.W)))
// val tm_out32 = VecInit(Seq.fill(4)(0.U(32.W)))
// val tm_out64 = VecInit(Seq.fill(2)(0.U(64.W)))

// val vd8 = VecInit(Seq.fill(16)(0.U(8.W)))
// val vd16 = VecInit(Seq.fill(8)(0.U(16.W)))
// val vd32 = VecInit(Seq.fill(4)(0.U(32.W)))
// val vd64 = VecInit(Seq.fill(2)(0.U(64.W)))

// val v_out8 = VecInit(Seq.fill(16)(0.U(8.W)))
// val v_out16 = VecInit(Seq.fill(8)(0.U(16.W)))
// val v_out32 = VecInit(Seq.fill(4)(0.U(32.W)))
// val v_out64 = VecInit(Seq.fill(2)(0.U(64.W)))


// when (io.tm_sew === "b011".U) {                                //64
//     tm_out64(0) := io.V_out_alu(63,0).asUInt
//     tm_out64(1) := io.V_out_alu(127,64).asUInt

//     vd64(0) := io.alu_vd_data_pre(63,0).asUInt
//     vd64(1) := io.alu_vd_data_pre(127,64).asUInt

// }.elsewhen (io.tm_sew === "b010".U) {                          //32
//     tm_out32(0) := io.V_out_alu(31,0).asUInt
//     tm_out32(1) := io.V_out_alu(63,32).asUInt 
//     tm_out32(2) := io.V_out_alu(95,64).asUInt 
//     tm_out32(3) := io.V_out_alu(127,96).asUInt 

//     vd32(0) := io.alu_vd_data_pre(31,0).asUInt
//     vd32(1) := io.alu_vd_data_pre(63,32).asUInt 
//     vd32(2) := io.alu_vd_data_pre(95,64).asUInt 
//     vd32(3) := io.alu_vd_data_pre(127,96).asUInt 

// }.elsewhen (io.tm_sew === "b001".U) {                          //16
//     tm_out16(0) := io.V_out_alu(15,0).asUInt 
//     tm_out16(1) := io.V_out_alu(31,16).asUInt 
//     tm_out16(2) := io.V_out_alu(47,32).asUInt 
//     tm_out16(3) := io.V_out_alu(63,48).asUInt 
//     tm_out16(4) := io.V_out_alu(79,64).asUInt 
//     tm_out16(5) := io.V_out_alu(95,80).asUInt 
//     tm_out16(6) := io.V_out_alu(111,96).asUInt 
//     tm_out16(7) := io.V_out_alu(127,112).asUInt 
    
//     vd16(0) := io.alu_vd_data_pre(15,0).asUInt 
//     vd16(1) := io.alu_vd_data_pre(31,16).asUInt 
//     vd16(2) := io.alu_vd_data_pre(47,32).asUInt 
//     vd16(3) := io.alu_vd_data_pre(63,48).asUInt 
//     vd16(4) := io.alu_vd_data_pre(79,64).asUInt 
//     vd16(5) := io.alu_vd_data_pre(95,80).asUInt 
//     vd16(6) := io.alu_vd_data_pre(111,96).asUInt 
//     vd16(7) := io.alu_vd_data_pre(127,112).asUInt 

// }.elsewhen (io.tm_sew === "b000".U) {                          //8
//     tm_out8(0) := io.V_out_alu(7,0).asUInt 
//     tm_out8(1) := io.V_out_alu(15,8).asUInt 
//     tm_out8(2) := io.V_out_alu(23,16).asUInt 
//     tm_out8(3) := io.V_out_alu(31,24).asUInt 
//     tm_out8(4) := io.V_out_alu(39,32).asUInt 
//     tm_out8(5) := io.V_out_alu(47,40).asUInt 
//     tm_out8(6) := io.V_out_alu(55,48).asUInt 
//     tm_out8(7) := io.V_out_alu(63,56).asUInt 
//     tm_out8(8) := io.V_out_alu(71,64).asUInt 
//     tm_out8(9) := io.V_out_alu(79,72).asUInt 
//     tm_out8(10) := io.V_out_alu(87,80).asUInt 
//     tm_out8(11) := io.V_out_alu(95,88).asUInt 
//     tm_out8(12) := io.V_out_alu(103,96).asUInt 
//     tm_out8(13) := io.V_out_alu(111,104).asUInt 
//     tm_out8(14) := io.V_out_alu(119,112).asUInt 
//     tm_out8(15) := io.V_out_alu(127,120).asUInt 

//     vd8(0) := io.alu_vd_data_pre(7,0).asUInt 
//     vd8(1) := io.alu_vd_data_pre(15,8).asUInt 
//     vd8(2) := io.alu_vd_data_pre(23,16).asUInt 
//     vd8(3) := io.alu_vd_data_pre(31,24).asUInt 
//     vd8(4) := io.alu_vd_data_pre(39,32).asUInt 
//     vd8(5) := io.alu_vd_data_pre(47,40).asUInt 
//     vd8(6) := io.alu_vd_data_pre(55,48).asUInt 
//     vd8(7) := io.alu_vd_data_pre(63,56).asUInt 
//     vd8(8) := io.alu_vd_data_pre(71,64).asUInt
//     vd8(9) := io.alu_vd_data_pre(79,72).asUInt 
//     vd8(10) := io.alu_vd_data_pre(87,80).asUInt 
//     vd8(11) := io.alu_vd_data_pre(95,88).asUInt 
//     vd8(12) := io.alu_vd_data_pre(103,96).asUInt 
//     vd8(13) := io.alu_vd_data_pre(111,104).asUInt 
//     vd8(14) := io.alu_vd_data_pre(119,112).asUInt 
//     vd8(15) := io.alu_vd_data_pre(127,120).asUInt 
// }
...
//                     v_out64(i) := vd64(i)
//                 }.elsewhen (io.v0(i) === 0.U && io.tm_vma === 1.U) {
//                     v_out64(i) := "b1111111111111111111111111111111111111111111111111111111111111111".U
//                 }.elsewhen (io.v0(i) === 1.U ) {
//                     v_out64(i) := tm_out64(i)
//                 }
//             }.otherwise {
...
//     }
//     io.Vector_Out := (Cat(v_out64(1), v_out64(0))).asUInt 
...
//                     v_out32(i) := vd32(i)
//                 }.elsewhen (io.v0(i) === 0.U && io.tm_vma === 1.U) {
//                     v_out32(i) := "b11111111111111111111111111111111".U
//                 }.elsewhen (io.v0(i) === 1.U ) {
//                     v_out32(i) := tm_out32(i)
//                 }
//             }.otherwise {
...
//     }
//     io.Vector_Out := (Cat(v_out32(3) ,v_out32(2) ,v_out32(1), v_out32(0))).asUInt 
...
//     }
//     io.Vector_Out := (Cat(v_out16(7), v_out16(6), v_out16(5), v_out16(4), v_out16(3), v_out16(2), v_out16(1), v_out16(0))).asUInt
...
//     }
//     io.Vector_Out := (Cat(v_out8(15), v_out8(14), v_out8(13), v_out8(12), v_out8(11), v_out8(10), v_out8(9), v_out8(8), v_out8(7), v_out8(6), v_out8(5), v_out8(4), v_out8(3), v_out8(2), v_out8(1), v_out8(0))).asUInt
