...
// note 
// vwredsum ===== vwredsumu.vs vd, vs2, vs1, vm # 2*SEW = 2*SEW + sum(zero-extend(SEW))
// add only first element of vs1 vector and then add all elements of vs2 vector
//length ==> vs1 = (sew*2), vs2= (sew)