...
// io.vec_dataout := 0.U
//   val wdata = VecInit(Seq.fill(4)(0.S(8.W)))
//   val rdata = VecInit(Seq.fill(4)(0.S(8.W)))
...
//     }.elsewhen(offset === 1.U){
//       // data to be stored at lower 16 bits (15,0)
//       wdata(0) := io.mem_data(23,16).asSInt
//       wdata(1) := io.mem_data(7,0).asSInt
//       wdata(2) := io.mem_data(15,8).asSInt
//       wdata(3) := io.mem_data(31,24).asSInt
//       mask(0)  := 0.B
//       mask(1)  := 1.B
//       mask(2)  := 1.B
...
//       wdata(2) := io.mem_data(7,0).asSInt
//       wdata(3) := io.mem_data(15,8).asSInt
//       wdata(0) := io.mem_data(23,16).asSInt
//       wdata(1) := io.mem_data(31,24).asSInt
//       mask(0)  := 0.B
//       mask(1)  := 0.B
//       mask(2)  := 1.B
//       mask(3)  := 1.B
...
//     when(io.f3 === "b010".U) {
//       // load word
//       io.dataout := Cat(rdata(3),rdata(2),rdata(1),rdata(0)).asSInt
//     }
//       .elsewhen(io.f3 === "b000".U) {
//         // load byte
//         when(offset === "b00".U) {
//           // addressing memory with 0,4,8...
//           io.dataout := Cat(Fill(24,rdata(0)(7)),rdata(0)).asSInt
...
//           io.dataout := Cat(Fill(24, rdata(2)(7)),rdata(2)).asSInt
//         } .elsewhen(offset === "b11".U) {
//           // addressing memory with 3,7,11...
//           io.dataout := Cat(Fill(24, rdata(3)(7)),rdata(3)).asSInt
//         } .otherwise {
...
//         when(offset === "b00".U) {
//           // addressing memory with 0,4,8...
//           io.dataout := Cat(Fill(16, 0.U),rdata(1),rdata(0)).asSInt
//         } .elsewhen(offset === "b01".U) {
//           // addressing memory with 2,6,10...
//           io.dataout := Cat(Fill(16, 0.U),rdata(2),rdata(1)).asSInt
//         } .elsewhen(offset === "b10".U) {
//           // addressing memory with 2,6,10...
//           io.dataout := Cat(Fill(16, 0.U),rdata(3),rdata(2)).asSInt
//         } .otherwise {
//           // this condition would never occur but using to avoid Chisel generating VOID errors
//           io.dataout := Cat(rdata(3),rdata(2),rdata(1),rdata(0)).asSInt
//         }
...
//         when(offset === "b00".U) {
//           // addressing memory with 0,4,8...
//           io.dataout := Cat(Fill(16, rdata(1)(7)),rdata(1),rdata(0)).asSInt
//         } .elsewhen(offset === "b01".U) {
//           // addressing memory with 1,3,7...
//           io.dataout := Cat(Fill(16, rdata(2)(7)),rdata(2),rdata(1)).asSInt
//         } .elsewhen(offset === "b10".U) {
//           // addressing memory with 2,6,10...
//           io.dataout := Cat(Fill(16, rdata(3)(7)),rdata(3),rdata(2)).asSInt
//         } .otherwise {
//           // this condition would never occur but using to avoid Chisel generating VOID errors
//           io.dataout := Cat(rdata(3),rdata(2),rdata(1),rdata(0)).asSInt
//         }
